...
if __name__ == '__main__':
    ...
    video_path = os.path.join(args.data_dir, args.content, 'video', '2160p_12000kbps_s0_d300.webm')
    adb_push(device_video_dir, video_path, args.device_id)
    video_path = os.path.join(args.data_dir, args.content, 'video', '720p_2640kbps_s0_d300.webm')
    adb_push(device_video_dir, video_path, args.device_id)
